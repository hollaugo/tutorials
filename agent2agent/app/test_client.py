    ...
    async with httpx.AsyncClient() as httpx_client:
        ...
        send_message_payload: dict[str, Any] = {
            'message': {
                'role': 'user',
                'parts': [
                    {'kind': 'text', 'text': 'Get a stock summary for AAPL.'}
                ],
                'messageId': uuid4().hex,
            },
        }
        ...
        send_message_payload_multiturn: dict[str, Any] = {
            'message': {
                'role': 'user',
                'parts': [
                    {'kind': 'text', 'text': 'Get the latest SEC filings for TSLA.'}
                ],
                'messageId': uuid4().hex,
            },
        }
        ...
        second_send_message_payload_multiturn: dict[str, Any] = {
            'message': {
                'role': 'user',
                'parts': [
                    {'kind': 'text', 'text': 'Summarize analyst recommendations for MSFT.'}
                ],
                'messageId': uuid4().hex,
                'taskId':task_id,
                'contextId': contextId
